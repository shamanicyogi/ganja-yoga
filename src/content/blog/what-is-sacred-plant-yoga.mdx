---
title: What is Sacred Plant Yoga
...
thumbnail: /src/assets/grand_daddy_purple.jpg
---

import { Image } from "astro:assets";
import confident from "/src/assets/confident.jpg";
import depressed from "/src/assets/depressed.jpg";
import prayer from "/src/assets/prayer.jpg";

# What is Sacred Plant Yoga 🍃

#

Sacred Plant Yoga is an ancient ritual that has been practiced for thousands of years.

#

To understand Sacred Plant Yoga we must first understand what yoga is.
...
<Image
  src={prayer}
  alt="A yogi with prayer hands."
  style={{ maxHeight: "400px", height: "400px", width: "auto" }}
/>
...
<Image
  src={depressed}
  alt="A person with depressed, slumped posture."
  style={{ maxHeight: "400px", height: "400px", width: "auto" }}
/>
<span style={{ alignSelf: "center" }}>Depressed, closed posture.</span>

#

<Image
  src={confident}
  alt="A person with confident, open posture."
  style={{ maxHeight: "400px", height: "400px", width: "auto" }}
/>

<span style={{ alignSelf: "center" }}>Confident, open posture.</span>
...
So finally bringing this back to Sacred Plant Yoga, how can this practice help facilitate this process?
...
In another article I will explain how to go about practicing Sacred Plant Yoga.
